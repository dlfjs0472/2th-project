...
public class ChatSelect extends JFrame{
	...
	public ChatSelect(AppMain appMain) {
		...
		la_north.setPreferredSize(new Dimension(300, 35));
		la_north.setHorizontalAlignment(JLabel.CENTER);
		la_north.setOpaque(true);
		la_north.setBackground(Color.WHITE);
		la_north.setHorizontalAlignment(JLabel.CENTER);
		...
		la_online.setFont(new Font("맑은 고딕", Font.BOLD, 14));
		la_online.setPreferredSize(new Dimension(300,20));

		//p_container.setBackground(Color.WHITE);
		//p_list.setBackground(Color.WHITE);
		p_north.setBackground(new Color(34, 45, 50));
		p_north.setPreferredSize(new Dimension(330, 45));
		//p_center.setBackground(Color.WHITE);
		
		
		p_list.setBorder(new EmptyBorder(0,0,0,0));
		p_list.setPreferredSize(new Dimension(300, 400));
